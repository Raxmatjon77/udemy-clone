...
export class CategoryController {
  ...
  async createCategory(@UploadedFile() image: Express.Multer.File, @Body() payload: CreateCategoryDto): Promise<void> {
    return this.#_service.createCategory(payload, image)
  }

  @Patch(':id')
  async updateCategory(@Param('id') id: string, @Body() payload: UpdateCategoryDto): Promise<Category> {
