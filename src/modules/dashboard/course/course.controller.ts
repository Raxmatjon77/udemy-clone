import { Controller, Post, Body, UploadedFile, UseInterceptors, Get, Param, Delete, Patch, Query } from '@nestjs/common'
...
export class CourseController {
  ...
  async createCourse(@Body() body: CreateCourseDto, @UploadedFile() image: Express.Multer.File) {
