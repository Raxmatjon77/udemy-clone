...
const SCRYPT_KEY = Number(process.env.SCRYPT_KEY)
  ? Number(process.env.SCRYPT_KEY)
  : 32;
const SCRYPT_SALT = Number(process.env.SCRYPT_SALT)
  ? Number(process.env.SCRYPT_SALT)
  : 16;
